...
class VisionService
  ...
  PROMPT = 'Describe this archival image in one sentence of 125 characters or less for use as HTML ' \
           'alt-text. Do not use phrases like "Image of" or "Photo of". Return only the description.'
  ...
  #
  # @param file_set [FileSet] must be an image type (not PDF)
